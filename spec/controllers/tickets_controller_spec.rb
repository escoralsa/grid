...
describe TicketsController do
  ...
  let(:valid_attributes) { { "date" => "2016-04-20 10:47:27" } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested ticket" do
        ...
        Ticket.any_instance.should_receive(:update).with({ "date" => "2016-04-20 10:47:27" })
        put :update, {:id => ticket.to_param, :ticket => { "date" => "2016-04-20 10:47:27" }}, valid_session
      end
