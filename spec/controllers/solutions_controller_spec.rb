  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved solution as @solution" do
        ...
        post :create, {:solution => { "description" => "invalid value" }}, valid_session
        assigns(:solution).should be_a_new(Solution)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested solution" do
        ...
        Solution.any_instance.should_receive(:update).with({ "description" => "MyText" })
        put :update, {:id => solution.to_param, :solution => { "description" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the solution as @solution" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Solution.any_instance.stub(:save).and_return(false)
        put :update, {:id => solution.to_param, :solution => { "description" => "invalid value" }}, valid_session
        assigns(:solution).should eq(solution)
      end
