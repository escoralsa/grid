...
describe ActivitiesController do
  ...
  let(:valid_attributes) { { "date" => "2016-04-20 10:56:54" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved activity as @activity" do
        ...
        post :create, {:activity => { "date" => "invalid value" }}, valid_session
        assigns(:activity).should be_a_new(Activity)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested activity" do
        ...
        Activity.any_instance.should_receive(:update).with({ "date" => "2016-04-20 10:56:54" })
        put :update, {:id => activity.to_param, :activity => { "date" => "2016-04-20 10:56:54" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the activity as @activity" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Activity.any_instance.stub(:save).and_return(false)
        put :update, {:id => activity.to_param, :activity => { "date" => "invalid value" }}, valid_session
        assigns(:activity).should eq(activity)
      end
