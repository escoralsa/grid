  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved device as @device" do
        ...
        post :create, {:device => { "storeNumbre" => "invalid value" }}, valid_session
        assigns(:device).should be_a_new(Device)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested device" do
        ...
        Device.any_instance.should_receive(:update).with({ "storeNumbre" => "1" })
        put :update, {:id => device.to_param, :device => { "storeNumbre" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the device as @device" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Device.any_instance.stub(:save).and_return(false)
        put :update, {:id => device.to_param, :device => { "storeNumbre" => "invalid value" }}, valid_session
        assigns(:device).should eq(device)
      end
